...
{
    public partial class ProductsDuo : System.Web.UI.Page
    {
        ...
        protected void BtnRegistroProducto_Click(object sender, EventArgs e)
        {
            ...
            Perfil.RegTituloProducto = TxtNombre.Text;
            Perfil.RegDescripcionProducto = TxtAcerca.Text;
            Perfil.RegPreciProducto = TxtPrecio.Text.Replace(",",".");
