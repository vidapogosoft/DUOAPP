<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductsDuo2.aspx.cs" Inherits="Cn_Seguridad.WebView.ProductsDuo2" %>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid">
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <asp:Label runat="server" visible="false" ID="LblRegistro" style="color:red; font-size:20px; font-style:italic;">Tu producto en la tienda ha sido registrado.</asp:Label>
                        </div>
                    </div>
                     </div>
