<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductsDuo.aspx.cs" Inherits="Cn_Seguridad.WebView.ProductsDuo" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Portal Duo: Registro de productos de mi tienda</title>
            ...
            <ContentTemplate>
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-header row" id="DivProductos">
                        <asp:HiddenField runat="server" ClientIDMode="Static" ID="hdfIdProducto" />
                  ...
                  <div class="row">
                          ...
                          <asp:Image runat="server" Width="180px" Hight ="280px" ID="img_foto_reg"/>
                ...
                <div class="page-header row">
                    ...
                    <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-12">
                            <asp:TextBox runat="server" placeholder="Registra el nombre de tu producto" class="form-control" MaxLength="50" ID="TxtNombre" autocomplete="off" ClientIDMode="Static"/>
                        </div>
                    </div>
                  
                              <div class="row">
                        <div class="col-md-12">
                              <asp:TextBox runat="server" placeholder="Registra una breve descripcion de tu producto" class="form-control" MaxLength="100" ID="TxtAcerca" autocomplete="off" ClientIDMode="Static" TextMode="MultiLine" Rows="3"/>
                           ...
                           <div class="row">
                        <div class="col-md-12">
                            <asp:TextBox runat="server" placeholder="Registra el precio de tu producto" class="form-control" MaxLength="8" ID="TxtPrecio" autocomplete="off" ClientIDMode="Static"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <asp:Label runat="server" visible="false" ID="LblRegistro" style="color:red; font-size:14px; font-style:italic;">Tu producto en la tienda ha sido registrado.</asp:Label>
                        </div>
                    </div>
                     </div>
                    ...
                    <div class="page-header row">
                           <div class="row">
                               <div class="col-md-12 text-center">
                                   <asp:Button runat="server" class="btn-lg btn-primary" Text="Registrar Producto" ID="BtnRegistroProducto" OnClick="BtnRegistroProducto_Click" />
                               </div>
                           </div>
                    </div>
