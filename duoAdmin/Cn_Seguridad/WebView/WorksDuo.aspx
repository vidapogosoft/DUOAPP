<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorksDuo.aspx.cs" Inherits="Cn_Seguridad.WebView.WorksDuo" %>
            ...
            <ContentTemplate>
                ...
                <div class="page-header row">
                    ...
                    <div class="col-md-12">
                     <div class="row">
                        <div class="col-md-12">
                            <asp:TextBox runat="server" placeholder="Cuentanos que hiciste en este trabajo" class="form-control" MaxLength="100" ID="TxtAcerca" autocomplete="off" ClientIDMode="Static" TextMode="MultiLine" Rows="3"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <asp:Label runat="server" visible="false" ID="LblRegistro" style="color:red; font-size:14px; font-style:italic;">Tu trabajo realizado ha sido registrado.</asp:Label>
                        </div>
                    </div>
                     </div>
                    <div class="page-header row">
